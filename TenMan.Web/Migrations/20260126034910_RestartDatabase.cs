        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Letra = table.Column<string>(nullable: false),
                    Description = table.Column<string>(maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitId = table.Column<int>(nullable: true),
                    UnitDescriptionLineId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CategoriesPercent_UnitDescriptionLine_UnitDescriptionLineId",
                        column: x => x.UnitDescriptionLineId,
                        principalTable: "UnitDescriptionLine",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpensesCostId = table.Column<int>(nullable: true),
                    FixedCostId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReceiptImages_ExpensesCosts_ExpensesCostId",
                        column: x => x.ExpensesCostId,
                        principalTable: "ExpensesCosts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReceiptImages_FixedCosts_FixedCostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesPercent_UnitDescriptionLineId",
                table: "CategoriesPercent",
                column: "UnitDescriptionLineId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptImages_ExpensesCostId",
                table: "ReceiptImages",
                column: "ExpensesCostId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceiptImages_FixedCostId",
                table: "ReceiptImages",
                column: "FixedCostId");
